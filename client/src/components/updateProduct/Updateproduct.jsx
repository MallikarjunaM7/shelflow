            ...
            <div className="product-form-container">
                ...
                <form className="product-form" onSubmit={handleSubmit} >
                    <label className="product-form-label">Product Name
                        <input type="text" name="productname" value={product.productname} onChange={handleChange} disabled className="product-form-input" required />
                    </label>
                    ...
                    <label className="product-form-label">Total Sold
                        <input type="number" name="total_sold" value={product.total_sold} onChange={handleChange} disabled className="product-form-input" required />
                    </label>
