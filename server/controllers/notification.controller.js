...
const sendNotification = async (req, res) => {
  try {
    ...
    const thresholdNotifications = thresholdProducts.map((product) => ({
      ...
      description: `Product ${product.productname} you ordered on ${product.current_date} is below the threshold level. Current quantity: ${product.quantity}, Threshold: ${product.productthreshold}.`,
    }));
